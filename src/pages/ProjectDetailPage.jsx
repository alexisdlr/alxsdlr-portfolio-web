...
import ProjectNavCard from "../components/Projects/ProjectNavCard";
...
const ProjectDetailPage = () => {
  ...
  return (
    <Box minH="100vh" color="gray.200" py={{ base: 8, md: 12 }}>
      ...
      <Text fontSize={{ base: "md", md: "lg" }} color="gray.300" lineHeight="1.8" mb={8}>
      ...
      <Box borderTop="1px solid" borderColor="whiteAlpha.100" pt={{ base: 10, md: 12 }}>
        <Heading as="h2" fontSize={{ base: "2xl", md: "3xl" }} color="white" mb={2}>
